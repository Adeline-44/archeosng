 ...
 */
final class Version20221028101257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE working_period DROP prof_id, DROP prof');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE working_period ADD prof_id INT DEFAULT NULL, ADD prof INT DEFAULT NULL');
